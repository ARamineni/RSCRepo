...
public class BaseTest 
{
	...
	public static void init() throws Exception
	{
		...
		p = new Properties();
		p.load(fis);
		String value = p.getProperty("LSTURL");
		...
		childProp.load(fis);
		String v = childProp.getProperty("LSTURL");
		...
		fis = new FileInputStream(projectPath+"/src/main/resources/log4j.properties");
		PropertyConfigurator.configure(fis);
		
		rep = ExtentReportMa.getInstance();
	}
	...
	public static void launcher(String browser)
	{
		if(p.getProperty(browser).equals("chrome")) {
			...
			//option.addArguments("user-data-dri"+ "C:\\Users\\MYGOIND000044\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 3");
			...
			FirefoxProfile profile = p.getProfile("SeleniumTesting");
	...
	public static void clickElementdropdown(String locatorKey) 
	{
